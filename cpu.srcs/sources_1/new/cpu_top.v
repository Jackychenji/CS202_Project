...
module cpu_top( input fpga_clk,
    ...
    wire spg_bufg;
    BUFG U1(.I(start_pg), 
            .O(spg_bufg)); // de-twitter// Generate UART Programmer reset signal
    //generate UART reset signal
    reg upg_rst;
    ...
    control32 controller(   Opcode,
       ...
       //CONNECT DATA RAM OR IO PORT RELATED
       //opcplus4:来自取指单元，JAL should be link_addr
    decode32 decoder(   read_data_1,
                        read_data_2,
                        Instruction_o_if,
                        r_wdata,
                        ALU_Result,
    ...
    dmemory32_Uart data_memory( clk_out,
                                MemWrite,
                                addr_out,
                                write_data,
                                readData,
   ...
   //pc plus 4 from ifetch (link_addr or branchbase?) should be branchbase
    ...
    Ifetc32 ifetch( branch_base_addr,
                    Addr_Result,
                    read_data_1,
                    Branch,
                    nBranch,
